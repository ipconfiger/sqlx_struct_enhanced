...
mod extended_types_integration_tests {
    ...
    async fn test_extended_types_insert_select_numeric() {
        ...
        let selected = ExtendedTypesTest::where_query("id = {}")
    ...
    async fn test_extended_types_complex_where() {
        ...
        let results = ExtendedTypesTest::where_query("tiny_int = {} AND small_int > {}")
            .bind_proxy(3i16)
            .bind_proxy(1002i16)
            .fetch_all(&pool)
            .await
        ...
        // Test with f32
        let results = ExtendedTypesTest::where_query("float_val BETWEEN {} AND {}")
            .bind_proxy(2.0f32)
            .bind_proxy(4.0f32)
            .fetch_all(&pool)
            .await
    ...
    async fn test_extended_types_unsigned_where() {
        ...
        let selected = ExtendedTypesTest::where_query("tiny_uint = {}")
            .bind_proxy(255u8)
            .fetch_optional(&pool)
            .await
        ...
        // Test with u16
        let selected = ExtendedTypesTest::where_query("small_uint = {}")
            .bind_proxy(65535u16)
            .fetch_optional(&pool)
            .await
            .expect("Failed to query record");
        ...
        // Test with u32
        let selected = ExtendedTypesTest::where_query("medium_uint = {}")
